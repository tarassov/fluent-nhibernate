...
$DEFAULT_NUGET_SOURCE_TO_PUSH_TO = "\\M25-S-DBTEST\Packages"
...
$NUGET_EXE_SUCCESSFULLY_CREATED_PACKAGE_MESSAGE_REGEX = [regex] "(?i)(Пакет ""(?<FilePath>.*?)"" успешно создан.)"
$NUGET_EXE_SUCCESSFULLY_PUSHED_PACKAGE_MESSAGE = 'Ваш пакет был отправлен.'
